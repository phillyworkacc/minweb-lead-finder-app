...
export default function LoadingLeadCollectionPage () {
   return (
      <AppWrapper>
         <div className="text-s full pd-1 bold-500 dfb align-center gap-10">
            <UserRound size={20} /> Lead Collection Page
         </div>
         <div className="text-xxxs grey-5 full pd-05">
            We are getting all your leads for this collection, please be patient
         </div>
