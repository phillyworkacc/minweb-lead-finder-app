...
export default function LoadingAutoLeadListPage () {
   return (
      <AppWrapper>
         <div className="text-s full pd-1 bold-500 dfb align-center gap-10">
            <UserRound size={20} /> Automated Lead List Page
         </div>
         <div className="text-xxxs grey-5 full pd-05">
            We are getting all your automated leads for this lead list, please be patient
         </div>
