...
export default function Select ({ options, defaultOptionIndex, onSelect, style, optionStyle, selectedOptionStyle, selectedOptionClassName, optionClassName }: SelectProps) {
   ...
   return (
      <div className="select" style={style}>
         <div className="selected-option" onClick={() => setShowDropdown(prev => !prev)}>
            <div className="content" style={selectedOptionStyle}><span className={selectedOptionClassName} style={selectedOptionStyle}>{options[initialOption]}</span></div>
            ...
            {options.map((option, index) => {
               return <div 
                  ...
                  onClick={() => {
                     ...
                     setShowDropdown(false);
               }}><span className={optionClassName}>{option}</span></div>
            })}
         </motion.div>}
      </div>
   )
