...
import { websiteScrapedInfoResolver } from '@/machine/typeResolver';
...
import LeadsCardView from '@/modals/LeadsCardView';
import Checkbox from '../Checkbox/Checkbox';

type LeadCardsV2Props = {
   leads: Lead[];
}
...
export default function LeadCardsV2 ({ leads }: LeadCardsV2Props) {
   ...
   function openFilteredAutoLeadsView (lead: Lead) {
      showMassiveModal({
         content: <LeadsCardView 
            leads={applyFilters(allLeads)} 
